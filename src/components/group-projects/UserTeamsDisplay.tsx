  ...
  return (
    <div className="mb-8 bg-gradient-to-r from-purple-600/10 to-pink-600/10 rounded-2xl p-6 border border-purple-500/20">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-xl font-bold text-purple-800 dark:text-purple-300">Your Teams ({userTeams.length}/3)</h3>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {userTeams.map((team) => (
          <div
            key={team.team_id}
            className="flex items-center gap-3 bg-white/80 dark:bg-slate-800/50 rounded-lg p-4 border border-purple-500/20"
          >
            <div className={`p-2 bg-gradient-to-br ${team.team_color_scheme} rounded-lg`}>
              <Users className="w-5 h-5 text-white" />
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-white">{team.team_name}</h4>
